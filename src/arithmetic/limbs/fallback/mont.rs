...
use super::super::super::{
    ffi::bn_mul_mont_ffi, montgomery::{limbs_from_mont_in_place, N0}, LimbSliceError,
    MAX_LIMBS,
    MIN_LIMBS,
};
use crate::{
...
pub(crate) fn limbs_mul_mont<'o>(
    ...
    unsafe {
        bn_mul_mont_ffi::<(), MIN_LIMBS, MOD_FALLBACK>(in_out, n, n0, (), bn_mul_mont_fallback)
    }
}
